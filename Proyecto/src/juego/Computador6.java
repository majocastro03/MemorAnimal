...
public class Computador6 extends JFrame implements ActionListener {
	...
	public Computador6(String nombreJug) {
	...
	public void Jugar() {
		for (int i = 0; i < arreglo.length; i++) {
			i = (int) (Math.random() * 36); //el numero aleatorio es dependiendo la dificultad 
	...
	public static void main(String nombreJug) {
		new Computador6(nombreJug).setVisible(true);
