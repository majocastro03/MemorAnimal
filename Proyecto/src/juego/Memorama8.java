...
public class Memorama8 extends JFrame implements ActionListener {
	...
	public Memorama8(String nombre) {
		iniciarTablero(nombre);

	}
	public Memorama8(String nombre, String nombre2) {
		iniciarTablero(nombre, nombre2);

	}

	public final void iniciarTablero(String nombreJug) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Memorama8.class.getResource("/imagenes/pata1sinfondo.png")));
		...
		btnSalir.setIcon(new ImageIcon(Memorama8.class.getResource("/imagenes/pata1peq.png")));
	...
	public static void main(String nombre, String nombre2) {
		new Memorama8(nombre,nombre2).setVisible(true);
		
		}
	
	public static void main(String nombre) {

		new Memorama8(nombre).setVisible(true);;
		}
}