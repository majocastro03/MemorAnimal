...
public class Memorama6 extends JFrame implements ActionListener {
	...
	public Memorama6(String nombre) {
		iniciarTablero(nombre);

	}
	public Memorama6(String nombre, String nombre2) {
		iniciarTablero(nombre, nombre2);

	}

	public final void iniciarTablero(String nombreJug) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Memorama6.class.getResource("/imagenes/pata1sinfondo.png")));
		...
		btnSalir.setIcon(new ImageIcon(Memorama6.class.getResource("/imagenes/pata1peq.png")));
		...
		for (int i = 470; i > 9; i=i-92) {
			for (int j =0 ; j < 6; j++) {
			JButton boton = new JButton("");
			boton.setBorder(null);
			boton.setIcon(new ImageIcon(Memorama6.class.getResource("/imagenes/tarjetaAtras82x82.png")));
			boton.setBounds((i), (j)*94, 82, 82);
	...
	public final void iniciarTablero(String nombreJug, String nombreJug2) {
		...
		nombre1=nombreJug;
		nombre2=nombreJug2;
		numJugador = ElegirJugador(nombreJug, nombreJug2);
		if (numJugador == 1) {
		...
		nombre2.setBounds(427, 25, 169, 42);
	...
	public void revolver2() {
		...
		Carta cartaTemporal[] = new Carta[36]; //arreglo de cartas temporales
		for (int i = 0; i < cartaTemporal.length; i++) {
			cartaTemporal[i] = new Carta(0, "/imagenes/tarjetaAtras82x82.png", -1);
		}
		while (llenar <= 35) {
	...
	public void MostrarCartas() {
		...
		for (int i = 0; i < cartas.length; i++) {
			cartas[i].boton.setIcon(new ImageIcon(this.getClass().getResource("fondo.gif")));
		}
	}
	...
	public void tapar(int a) {
		cartas[a].boton.setIcon(new ImageIcon(this.getClass().getResource("/imagenes/tarjetaAtras82x82.png")));//voltear carta
		cartas[Integer.valueOf(temporal.boton.getName())].revelado=false;
		cartas[Integer.valueOf(temporal.boton.getName())].boton.setIcon((new ImageIcon(this.getClass().getResource("/imagenes/tarjetaAtras82x82.png"))));
	}
	...
	public static void main(String nombre, String nombre2) {
		new Memorama6(nombre,nombre2).setVisible(true);
		
		}
	
	public static void main(String nombre) {

		new Memorama6(nombre).setVisible(true);;
		}
}